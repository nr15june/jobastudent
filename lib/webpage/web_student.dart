...
import 'package:jobastudent/webpage/post_student.dart'; // เพิ่มการนำเข้าไฟล์ CreatePostPage

class WebStudentPage extends StatefulWidget {
  const WebStudentPage({super.key});

  @override
  _WebPerfessorPageState createState() => _WebPerfessorPageState();
}

class _WebPerfessorPageState extends State<WebStudentPage> {
